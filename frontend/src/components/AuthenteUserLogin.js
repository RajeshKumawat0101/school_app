...
const AuthenteUserLogin = () => {
    ...
    const handleSubmit=async(e)=>{
        e.preventDefault();
         await axios.post("http://localhost:4000/user/loginUser" ,{name,email,password}).then((result)=>{
              console.log(result);
...
export default AuthenteUserLogin
